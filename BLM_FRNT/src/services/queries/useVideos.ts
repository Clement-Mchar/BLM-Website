...
export function useCreateVideo() {
  ...
  return useMutation({
    ...
    onSuccess: (video) => {
      ...
      toast({
        title: "Video created",
        description: `Video ${video?.title} created`,
        action: h(
          ToastAction,
          {
            altText: `Video created`,
          },
          {
            default: () => "Continue",
          },
...
export function useDeleteVideo(id: string) {
  ...
  return useMutation({
    ...
    onSuccess: (video) => {
      ...
      toast({
        title: "Video deleted",
        description: `${video?.title} deleted from database.`,
        action: h(
          ToastAction,
          {
            altText: `Video deleted`,
          },
          {
            default: () => "Continue",
          },
...
export function useUpdateVideo(id: string) {
  ...
  return useMutation({
    ...
    mutationFn: async ({ id, payload }: { id: string; payload: Partial<Video> }) => {
